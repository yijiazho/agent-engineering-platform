...
decisions before Tool execution. Docker validation now captures deterministic
per-command execution evidence behind that policy boundary. The end-to-end MVP
workflow is not yet runnable.
